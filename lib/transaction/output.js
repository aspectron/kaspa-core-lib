...
Output.prototype.toBufferWriter = function(writer) {
    ...
    writer.writeUInt64LEBN(this._satoshisBN); //value/amount
    writer.writeUInt16LE(0); //output.ScriptPublicKey.Version (uint 16)
    var script = this._scriptBuffer;
    let bn = BN.fromNumber(script.length);
    writer.writeUInt64LEBN(bn); //script length
